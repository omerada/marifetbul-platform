...
/**
 * ============================================================================
 * FOCUS TRAP - Use hooks/shared/ui/useAccessibility.ts instead
 * ============================================================================
 * DUPLICATE REMOVED: useFocusTrap() moved to dedicated file
 *
 * Reason: Two implementations existed:
 * - hooks/shared/ui/index.ts (basic) ❌ DUPLICATE
 * - hooks/shared/ui/useAccessibility.ts (production-ready) ✅ ACTIVE
 * - components/shared/accessibility/FocusTrap.tsx (component + hook) ✅ ACTIVE
 *
 * Use: import { useFocusTrap } from '@/hooks/shared/ui/useAccessibility'
 *   or import { useFocusTrap } from '@/components/shared/accessibility'
 * ============================================================================
 */
