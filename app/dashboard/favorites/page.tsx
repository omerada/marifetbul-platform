            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  {stats.totalFavorites} kay�tl� favori
                </p>
              </div>
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <option value="all">T�m Favoriler</option>
                  <option value="freelancers">Freelancerlar</option>
                  <option value="jobs">��ler</option>
          ...
          {totalFiltered === 0 ? (
            <Card className="p-12 text-center">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">
                {searchQuery ? 'Sonu� bulunamad�' : 'Hen�z favori eklenmemi�'}
              </h3>
              <p className="text-gray-600">
                {searchQuery
                  ? 'Arama kriterlerinizi de�i�tirmeyi deneyin'
                  : 'Be�endi�iniz freelancer, i� veya paketleri favorilere ekleyin'}
              </p>
            </Card>
          ) : (
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-xs text-gray-500">{folder.itemCount || 0} ��e</p>
      </div>
