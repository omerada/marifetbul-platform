...
function DisputeDashboardContent() {
  ...
  const loadDisputes = useCallback(async () => {
    ...
    try {
      ...
      toast.error('Veri Y�klenemedi', {
        description: '�tirazlar y�klenirken bir hata olu�tu.',
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const filterOptions: Array<{
    ...
    { value: 'all', label: 'T�m�', count: stats.total },
    { value: 'OPEN', label: 'A��k', count: stats.open },
    { value: 'UNDER_REVIEW', label: '�nceleniyor', count: stats.underReview },
    { value: 'ESCALATED', label: 'Y�kseltildi', count: stats.escalated },
    { value: 'RESOLVED', label: '��z�ld�', count: stats.resolved },
  ];
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <Loading size="lg" text="�tirazlar y�kleniyor..." />
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-600">
                T�m itirazlar�n�z� g�r�nt�leyin ve y�netin
              </p>
            </div>
          </div>
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">A��k</p>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">�nceleniyor</p>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Y�kseltildi</p>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">��z�ld�</p>
          ...
          <Card className="p-12">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">
                {selectedFilter === 'all'
                  ? 'Hen�z itiraz yok'
                  : `${filterOptions.find((f) => f.value === selectedFilter)?.label} itiraz bulunamad�`}
              </h3>
              <p className="mt-2 text-sm text-gray-600">
                {selectedFilter === 'all'
                  ? 'Sipari�lerinizle ilgili bir sorun ya�ad���n�zda itiraz olu�turabilirsiniz.'
                  : 'Bu kategoride g�r�nt�lenecek itiraz bulunmuyor.'}
              </p>
              {selectedFilter === 'all' && (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex items-center gap-4 text-sm text-gray-600">
                        <span className="flex items-center gap-1">
                          ...
                          Sipari� #{dispute.orderId.slice(0, 8)}
                        </span>
                        <span className="flex items-center gap-1">
                      ...
                      {isDisputeResolved(dispute) && dispute.resolution && (
                        <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-3">
                          <p className="text-xs font-medium text-green-700">
                            ��z�m: {dispute.resolution}
                          </p>
                          {dispute.resolvedAt && (
                            <p className="mt-1 text-xs text-green-600">
                              {formatDate(dispute.resolvedAt)} tarihinde ��z�ld�
                            </p>
                          )}
                        </div>
                      )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-blue-900">
                  �tiraz S�reci Hakk�nda
                </h3>
                <p className="mt-2 text-sm text-blue-800">
                  �tirazlar�n�z y�netim ekibimiz taraf�ndan 24-48 saat i�inde
                  incelenir. S�reci h�zland�rmak i�in l�tfen t�m gerekli
                  bilgileri ve kan�tlar� ekleyin. Sorular�n�z i�in{' '}
                  <Link
                    href="/support"
