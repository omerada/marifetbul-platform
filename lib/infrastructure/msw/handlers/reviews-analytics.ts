...
import type { GetAnalyticsResponse } from '@/types/business/features/analytics';
    ...
    const response: GetAnalyticsResponse = {
      ...
      data:
        userType === 'freelancer'
          ? {
              freelancer:
                mockFreelancerAnalytics as import('@/types/business/features/analytics').FreelancerAnalytics,
              employer: undefined,
            }
          : {
              freelancer: undefined,
              employer:
                mockEmployerAnalytics as import('@/types/business/features/analytics').EmployerAnalytics,
            },
      timeframe: 'month',
