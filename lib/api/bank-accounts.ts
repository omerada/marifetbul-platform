 ...
 *
 * GET /api/v1/admin/wallet/bank-accounts/pending
 *
...
export async function getPendingBankAccounts(params?: {
  ...
  return apiClient.get<{
    ...
    size: number;
    number: number;
  }>('/v1/admin/wallet/bank-accounts/pending', {
    page: page.toString(),
    size: size.toString(),
    sortBy,
    sortDirection,
 ...
 *
 * PUT /api/v1/admin/wallet/bank-accounts/{id}/verify
 *
 * @param id Bank account ID
...
export async function verifyBankAccount(
  ...
  const url = notes
    ? `/v1/admin/wallet/bank-accounts/${id}/verify?notes=${encodeURIComponent(notes)}`
    : `/v1/admin/wallet/bank-accounts/${id}/verify`;
 ...
 *
 * PUT /api/v1/admin/wallet/bank-accounts/{id}/reject
 *
 * @param id Bank account ID
...
export async function rejectBankAccount(
  ...
  return apiClient.put<BankAccountResponse>(
    `/v1/admin/wallet/bank-accounts/${id}/reject?reason=${encodeURIComponent(reason)}`,
    {}
  );
}
 ...
 *
 * GET /api/v1/admin/wallet/bank-accounts/statistics
 *
...
export async function getBankAccountStatistics(): Promise<{
  ...
  return apiClient.get<{
    ...
    verified: number;
    rejected: number;
  }>('/v1/admin/wallet/bank-accounts/statistics');
}
