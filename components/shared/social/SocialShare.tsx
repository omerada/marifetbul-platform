        ...
        {showCopyLink && (
          ...
          >
            ...
            <span className="hidden sm:inline">
              {copied ? 'Kopyaland�' : 'Linki Kopyala'}
            </span>
          </Button>
        )}
      </div>
  ...
  if (isLoading) {
    return (
      <div className={cn('flex items-center gap-2', className)}>
        ...
        <span className="text-muted-foreground text-sm">Y�kleniyor...</span>
      </div>
    );
  }
  ...
  return (
    <div className={cn('flex items-center gap-4', className)}>
      <div className="flex items-center gap-2">
        ...
        <span className="text-muted-foreground text-xs">payla��m</span>
      </div>
    ...
    case 'testimonials':
      return (
        <Card className={className}>
          <CardHeader>
            <CardTitle className="text-lg">Kullan�c� Yorumlar�</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {content.testimonials?.map((testimonial) => (
              ...
              <p className="text-muted-foreground text-sm">Hen�z yorum yok.</p>
            )}
          </CardContent>
        </Card>
      );
    ...
    case 'user_count':
      return (
        <div className={cn('py-6 text-center', className)}>
          ...
          <div className="text-muted-foreground text-sm">aktif kullan�c�</div>
        </div>
      );
