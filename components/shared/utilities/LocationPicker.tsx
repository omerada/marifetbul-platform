...
export const LocationPicker: React.FC<LocationPickerProps> = ({
  ...
  onLocationSelect,
  onClose,
  placeholder = 'Konum ara veya haritadan se�...',
        ...
        !isSearching && (
          <Card className="mb-4">
            <div className="p-4 text-center text-gray-500">
              ...
              <p className="text-sm">
                &ldquo;{searchQuery}&rdquo; i�in sonu� bulunamad�
              </p>
              <p className="mt-1 text-xs">Farkl� bir arama terim� deneyin</p>
            </div>
          </Card>
        )}
