...
function Toast({
  ...
  return (
    <div
      className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg border shadow-lg ${getBackgroundColor()} animate-in slide-in-from-top-2 duration-300`}
    >
      <div className="p-4">
