    ...
    return (
      <Card className="p-8 text-center">
        ...
        <p className="text-gray-600">
          Bu freelancer hen�z portfolyo ��esi eklememi�.
        </p>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">�al��malar�m�n �rnekleri</p>
        </div>
        {isOwnProfile && (
          <Button
      ...
      {portfolioItems.length === 0 ? (
        <Card className="p-8 text-center">
          ...
          <p className="mb-4 text-gray-600">
            Yeteneklerinizi sergilemek i�in projelerinizi ekleyin.
          </p>
          {isOwnProfile && (
            <Button onClick={handleAddItem} variant="outline">
              �lk Projenizi Ekleyin
            </Button>
          )}
        </Card>
      ) : (
        ...
        <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black">
          <Card className="mx-4 w-full max-w-md p-6">
            ...
            <p className="mb-6 text-gray-600">
              Bu portf�y ��esini silmek istedi�inizden emin misiniz? Bu i�lem
              geri al�namaz.
            </p>
