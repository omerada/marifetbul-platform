      ...
      <Card className={cn('p-4', className)}>
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">
            Bu makaleyi {selectedRating} y�ld�z ile de�erlendirdiniz.
            Te�ekk�rler!
          </p>
        </div>
      </Card>
    ...
    <Card className={cn('p-6', className)}>
      <div className="text-center">
        <h3 className="mb-2 text-lg font-semibold text-gray-900">
          Bu makale yararl� oldu mu?
        </h3>

        <p className="mb-4 text-sm text-gray-600">
          Deneyiminizi payla�arak di�er kullan�c�lara yard�mc� olun
        </p>
        ...
        <div className="border-t pt-4">
          <p className="mb-3 text-sm text-gray-600">
            Daha detayl� de�erlendirme yapmak isterseniz:
          </p>
            ...
            <div className="mt-4 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">
                  Geri bildiriminiz (iste�e ba�l�)
                </label>
                <Textarea
                  value={feedback}
                  onChange={(e) => setFeedback(e.target.value)}
                  placeholder="Bu makaleyi nas�l geli�tirebiliriz?"
                  rows={3}
                  className="mt-1"
                />
              </div>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1"
                >
                  {isSubmitting ? 'G�nderiliyor...' : 'De�erlendirmeyi G�nder'}
                </Button>
