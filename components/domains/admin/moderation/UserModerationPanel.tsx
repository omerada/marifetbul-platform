...
export function UserModerationPanel() {
  ...
  const handleUnsuspend = useCallback(async () => {
    ...
    const reason = prompt('Ask�y� kald�rma nedeni:');
    if (!reason) return;
  ...
  const handleRevokeWarning = useCallback(
    async (warningId: string) => {
      const reason = prompt('Uyar�y� iptal etme nedeni:');
      if (!reason) return;
      ...
      <Card>
        <CardHeader>
          ...
          <p className="mt-2 text-sm text-gray-600">
            Moderasyon i�lemi yapmak i�in kullan�c� ID&apos;si girin
          </p>
        </CardHeader>
        <CardContent>
          <div className="flex gap-2">
            <Input
              placeholder="Kullan�c� ID (UUID)"
              value={searchUserId}
            ...
            <Card className="border-red-300 bg-red-50">
              ...
              <CardContent className="space-y-4">
                <p className="mb-4 text-sm text-red-700">
                  Bu kullan�c� �u anda ask�ya al�nm�� durumda
                </p>
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    ...
                    {activeSuspension.expiresAt && (
                      <div>
                        <span className="font-semibold">Biti�:</span>{' '}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Aktif Uyar�lar ({activeWarnings.length})
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="mb-3 text-sm text-gray-600">
                  S�resiz olmayan veya iptal edilmemi� uyar�lar
                </p>
            ...
            <Card className="border-green-300 bg-green-50">
              <CardContent className="py-6 text-center">
                <p className="text-green-800">
                  ? Bu kullan�c�n�n aktif uyar�s� veya ask�ya al�nmas�
                  bulunmuyor
                </p>
              </CardContent>
            </Card>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="mt-4 text-gray-600">
              Moderasyon i�lemi yapmak i�in yukar�dan kullan�c� aray�n
            </p>
          </CardContent>
        </Card>
      )}
