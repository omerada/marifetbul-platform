        ...
        <div className="p-4">
          ...
          {isLoading && (
            <div className="space-y-3">
              <Loading variant="skeleton" size="lg" className="h-4 w-3/4" />
              <Loading variant="skeleton" size="lg" className="h-4 w-full" />
              <Loading variant="skeleton" size="lg" className="h-4 w-2/3" />
            </div>
          )}
