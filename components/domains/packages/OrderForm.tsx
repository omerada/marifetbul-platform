...
const orderSchema = z.object({
  requirements: z
    .string()
    .min(20, 'Gereksinimler en az 20 karakter olmal�d�r')
...
const additionalServiceOptions = [
  ...
  { id: 'commercial-license', name: 'Ticari Kullan�m Lisans�', price: 300 },
];
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Projeniz hakk�nda detayl� bilgi verin, beklentilerinizi a��klay�n..."
        />
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          Normal teslimat s�resi: {servicePackage.deliveryTime} g�n
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-500">
          Freelancer&apos;�n sizinle ileti�im kurmas� i�in
        </p>
      </div>
      ...
      <Card className="border-gray-200 bg-gray-50 p-4">
        <h4 className="mb-3 font-medium text-gray-900">Sipari� �zeti</h4>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
        <div className="text-sm text-blue-800">
          <p className="mb-2 font-medium">�nemli Bilgiler:</p>
          <ul className="space-y-1 text-xs">
            <li>
              � �deme, proje tamamland�ktan sonra freelancer&apos;a aktar�l�r
            </li>
            <li>� 7 g�n para iade garantisi mevcuttur</li>
            <li>� T�m ileti�im platform �zerinden yap�lmal�d�r</li>
            <li>� Proje iptal edilirse �cret iade edilir</li>
          </ul>
        </div>
      </div>
        ...
        <Button type="submit" disabled={isSubmitting} className="flex-1">
          {isSubmitting ? (
            ...
            <>
              ...
              �demeye Ge� (?{grandTotal.toLocaleString('tr-TR')})
            </>
          )}
        </Button>
        <Button
