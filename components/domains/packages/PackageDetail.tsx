...
export function PackageDetail({ packageId, className }: PackageDetailProps) {
  ...
  if (isLoading) {
    return <Loading variant="skeleton" text="Paket detaylar� y�kleniyor..." />;
  }

  if (error || !currentPackage) {
    return (
      <SimpleErrorDisplay
        error={error || 'Paket bulunamad�'}
  ...
  if (!isPackageDetail(currentPackage)) {
    return (
      <SimpleErrorDisplay
        message="Bu paket i�in detay g�r�n�m� mevcut de�il"
        onRetry={refreshPackageDetail}
      />
    );
  }
    ...
    <div className={`mx-auto max-w-6xl space-y-8 p-6 ${className}`}>
        ...
        <div className="mb-4 flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-sm font-medium text-gray-700">
              {currentTierData?.deliveryTime || 0} g�n
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Card>
            <Tabs defaultValue="description" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                <TabsTrigger value="description">A��klama</TabsTrigger>
                <TabsTrigger value="faq">S.S.S.</TabsTrigger>
                <TabsTrigger value="reviews">De�erlendirmeler</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="faq" className="p-6">
                <div className="space-y-4">
                  ...
                  )) || <p className="text-gray-500">Hen�z SSS eklenmemi�.</p>}
                </div>
              </TabsContent>

              <TabsContent value="reviews" className="p-6">
                <div className="text-center text-gray-600">
                  De�erlendirmeler y�kleniyor...
                </div>
              </TabsContent>
            </Tabs>
          </Card>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Sipari� �zeti</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
              ...
              <Button
                ...
                onClick={handleOrder}
              >
                {isOrdering ? 'Sipari� Veriliyor...' : 'Sipari� Ver'}
              </Button>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Hizmet Sa�lay�c�</CardTitle>
            </CardHeader>
            <CardContent>
              {currentPackage.freelancer ? (
                  ...
                  <div className="mb-4 flex items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>
                          {currentPackage.freelancer.reviewCount} de�erlendirme
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-500">Sa�lay�c� bilgisi mevcut de�il</p>
              )}
              ...
              <div className="mb-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span>Ba�ar� Oran�:</span>
                  <span>95%</span>
                </div>
                <div className="flex justify-between">
                  <span>Yan�t S�resi:</span>
                  <span>~2 saat</span>
                </div>
                <div className="flex justify-between">
                  <span>Konum:</span>
