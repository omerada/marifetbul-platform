...
export function MarketplacePage() {
  ...
  return (
    ...
    >
      {/* Hero Section - Yeni Modern Minimal Tasar�m */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700">
        ...
        <div className="relative container mx-auto px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          {/* �st K�s�m - Mode Toggle & Quick Stats */}
          <div className="mb-12 flex flex-col items-center gap-6">
            {/* Mode Toggle - Kompakt Tasar�m */}
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-white/90">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">98% Ba�ar�</span>
              </div>
            </div>
          </div>

          {/* Ana ��erik - Merkezi & Temiz */}
          <div className="mx-auto max-w-4xl text-center">
            {/* Ba�l�k - Sabit Y�kseklik */}
            <div className="mb-8 space-y-4">
              ...
              <p className="mx-auto max-w-2xl text-xl leading-relaxed text-blue-100 lg:text-2xl">
                {mode === 'jobs'
                  ? 'Binlerce i� f�rsat� aras�ndan sizin i�in en uygun olan� bulun ve hemen ba�vurun'
                  : '�htiyac�n�za �zel haz�r hizmet paketleri ile i�lerinizi kolayla�t�r�n'}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              {/* �zellik Badges - Minimal */}
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  { icon: Shield, text: 'G�venli �deme' },
                  { icon: Zap, text: 'H�zl� ��lem' },
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 lg:text-2xl">
                  {mode === 'jobs' ? '�� �lanlar�' : 'Hizmet Paketleri'}
                </h2>
