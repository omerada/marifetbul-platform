      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <div className="relative overflow-hidden">
            {/* Gradient Overlays */}
            <div className="absolute top-0 left-0 z-10 h-full w-16 bg-gradient-to-r from-gray-50 to-transparent"></div>
            <div className="absolute top-0 right-0 z-10 h-full w-16 bg-gradient-to-l from-gray-50 to-transparent"></div>
            ...
            <div className="animate-scroll flex items-center">
              ...
              {partnerships.map((partner, index) => (
                <div
                  key={`first-${index}`}
                  className="mx-8 flex h-16 w-16 flex-shrink-0 items-center justify-center opacity-70 transition-all duration-300 hover:scale-110 hover:opacity-100"
                >
                  <partner.component />
                </div>
              ))}
