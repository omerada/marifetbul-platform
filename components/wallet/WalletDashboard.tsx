  ...
  const quickActions: QuickAction[] = [
    {
      ...
      onClick: () =>
        onRequestPayout?.() || router.push('/dashboard/wallet/payouts'),
      variant: 'primary',
    ...
    },
    {
      ...
      onClick: () =>
        onViewTransactions?.() || router.push('/dashboard/wallet/transactions'),
      variant: 'outline',
    },
    {
      label: 'Çekim Geçmişi',
      ...
      onClick: () =>
        onViewPayouts?.() || router.push('/dashboard/wallet/payouts'),
      variant: 'outline',
    },
    {
      label: 'Yenile',
